...
public abstract class AbstractPentahoLdapIntegrationTests {
  ...
  public /* SpringSecurityContextSource TODO */ BaseLdapPathContextSource getContextSource() {
    return (/*SpringSecurityContextSource TODO */BaseLdapPathContextSource) appContext.getBean( BeanIds.CONTEXT_SOURCE );
  }
